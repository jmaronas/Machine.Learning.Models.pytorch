...
// avoid the loop over the data. Moreover, data x is passed so that column
// wise indexing can be performed. The final indexing is then transposed to match
// the requirements of categorical_logit_glm
