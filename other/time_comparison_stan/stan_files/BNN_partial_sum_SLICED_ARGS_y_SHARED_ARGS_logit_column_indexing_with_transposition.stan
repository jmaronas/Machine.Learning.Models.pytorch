...
// is done using column major order to allow efficient inference of the matrix p. However 
// in this script matrix multiplication is done following NN convention, so this script includes a matrix
// transposition.
...
model {
      ...
      profile("Matrix product and transposition"){
